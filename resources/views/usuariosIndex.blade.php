...
<a href="#" class="breadcrumb-item active"><i class="icon-users mr-2"></i> Usuários</a>
@endsection
            ...
            <form class="form-validate-jquery" method="GET" action="/usuarios/search">
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-form-label col-lg-1">Nome Completo<span class="text-danger">*</span></label>
                        <div class="col-lg-5">
                    ...
                    <table class="table text-nowrap">
                        ...
                        <tbody>
                            ...
                            @foreach($usuarios as $usuario)
                                <tr>
                                    <td>
                                        <div class="font-weight-semibold">{{ $usuario->name }} - {{ $usuario->email }} ({{ $usuario->username }})</div>
                                    </td>
